        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <h3 className="text-2xl font-bold">PideYa</h3>
                <p className="text-sm text-gray-400">Sistema de Pedidos</p>
              </div>
            </div>
            <p className="text-gray-300 mb-6 max-w-md">
              La plataforma más completa para digitalizar tu restaurante.
              Gestiona pedidos, mesas y menús de forma profesional y eficiente.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">hola@pideya.com</span>
              </li>
              <li className="flex items-center space-x-3">
